...
function ProgramsSection() {
  const programs = [
    ...
    },
    {
      ...
      text: 'text-brand-700',
      faculty: 'Business',
      programs: ['Business Administration', 'Marketing', 'Economics'],
    ...
    },
    {
      ...
      programs: ['Islamic Finance', 'Islamic Banking', 'Muamalat'],
    ...
    },
    {
      ...
      programs: ['Politics & International Relations', 'Sociology'],
    ...
    },
    {
      ...
      text: 'text-rose-700',
      faculty: 'Education',
      programs: ['Education (TESL)', 'Islamic Education', 'Early Childhood'],
    ...
    },
    {
      ...
      programs: ['Media Studies', 'Mass Communication', 'Journalism'],
