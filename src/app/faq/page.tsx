  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: 'Да, большинство саудовских университетов требуют профессиональный перевод документов на арабский язык. Мы выполняем такой перевод в срок 2–5 дней.',
      },
      {
        q: 'Что делать если документы на русском языке?',
        a: 'Это стандартная ситуация для наших клиентов. Мы выполняем профессиональный перевод на арабский и/или английский язык.',
      },
    ],
  },
  {
