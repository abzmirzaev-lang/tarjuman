...
export const metadata: Metadata = {
  ...
  description: 'Профессиональная помощь студентам из СНГ в поступлении в университеты Саудовской Аравии и ОАЭ. Перевод документов, подача заявок, оформление визы. Более 26 университетов-партнёров.',
  keywords: [
    ...
    'tarjuman',
    'поступление СНГ арабские университеты',
    'study in saudi arabia',
    'study in uae cis students',
  ],
  ...
  openGraph: {
    ...
    description: 'Профессиональная помощь студентам из СНГ. Перевод документов, подача заявок, оформление визы. Более 26 университетов-партнёров.',
    url: APP_URL,
    siteName: 'TARJUMAN',
    type: 'website',
    locale: 'ru_RU',
  ...
  twitter: {
    card: 'summary',
    title: 'TARJUMAN — Поступление в университеты Саудовской Аравии и ОАЭ',
    description: 'Профессиональная помощь студентам из СНГ в поступлении в арабские университеты.',
    images: ['/icon-512.png'],
  },
  alternates: {
    canonical: APP_URL,
...
const jsonLd = {
  ...
  description: 'Профессиональная помощь студентам из СНГ в поступлении в университеты Саудовской Аравии и ОАЭ.',
  contactPoint: {
    '@type': 'ContactPoint',
