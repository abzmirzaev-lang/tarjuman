...
export const metadata: Metadata = {
  ...
  openGraph: { title:'О нас | TARJUMAN EDU', description:'Профессиональная команда по поступлению в университеты Саудовской Аравии и ОАЭ. 43 заявки, 30+ партнёров.', url:`${U}/about`, type:'website', images:[{url:`${U}/og-image.png`,width:640,height:640}] },
