...
export const metadata: Metadata = {
  ...
  description: 'Tarjuman Edu помогает студентам из СНГ поступить в университеты Саудовской Аравии и ОАЭ. Перевод документов, подача заявки, сопровождение. 120+ обработанных заявок.',
  ...
  openGraph: { title:'О нас | TARJUMAN EDU', description:'Профессиональная команда по поступлению в университеты Саудовской Аравии и ОАЭ. 120+ заявок, 12+ партнёров.', url:`${U}/about`, type:'website', images:[{url:`${U}/og-image.png`,width:640,height:640}] },
