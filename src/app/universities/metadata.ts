...
export const metadata: Metadata = {
  ...
  description: 'Полный список университетов для подачи: Исламский университет Медины, King Saud University, Al Qasimia University, университеты ОАЭ. Подайте заявку онлайн.',
  ...
  openGraph: { title:'Университеты Саудовской Аравии и ОАЭ | TARJUMAN', description:'30+ ведущих университетов: КСА, ОАЭ, Катар. Al Qasimia, IUM, KSU, KAU. Подайте заявку онлайн.', url:`${U}/universities`, type:'website', images:[{url:`${U}/og-image.png`,width:640,height:640}] },
