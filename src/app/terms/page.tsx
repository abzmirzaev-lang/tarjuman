...
const CONTENT: Record<Lang, { hero: { badge: string; title: string; updated: string }; note: { title: string; body: string }; sections: { title: string; content: string }[] }> = {
  ru: {
    ...
    note: { title: 'Пожалуйста, ознакомьтесь внимательно', body: 'Используя сервис TARJUMAN, вы соглашаетесь соблюдать изложенные ниже условия. Вопросы — на tarjumanedu@gmail.com' },
    sections: [
      ...
      { title: '9. Контакты', content: `По всем вопросам: tarjumanedu@gmail.com\nTelegram: @TARJUMAN_KSA` },
    ],
  },
  uz: {
    hero: { badge: 'Huquqiy hujjatlar', title: 'Foydalanish shartlari', updated: 'Oxirgi yangilanish: 1 may 2025 y.' },
    note: { title: "Iltimos, diqqat bilan o'qing", body: "TARJUMAN xizmatidan foydalanib, siz quyidagi shartlarga roziligingizni bildirасиз. Savollar uchun: tarjumanedu@gmail.com" },
    sections: [
      ...
      { title: '9. Aloqa', content: "Barcha savollar uchun: tarjumanedu@gmail.com\nTelegram: @TARJUMAN_KSA" },
    ],
  },
  en: {
    hero: { badge: 'Legal Documents', title: 'Terms of Use', updated: 'Last updated: May 1, 2025' },
    note: { title: 'Please read carefully', body: 'By using TARJUMAN, you agree to comply with the terms below. Questions? Contact us at tarjumanedu@gmail.com' },
    sections: [
      ...
      { title: '9. Contact', content: `For all inquiries: tarjumanedu@gmail.com\nTelegram: @TARJUMAN_KSA` },
    ],
  },
}
        ...
        <div className="max-w-3xl mx-auto px-4 py-12 space-y-6">
          ...
          <div className="text-center py-4">
            <p className="text-xs text-muted">
              <a href="mailto:tarjumanedu@gmail.com" className="text-ink underline hover:opacity-70">tarjumanedu@gmail.com</a>
            </p>
          </div>
        </div>
      </div>
