...
const CONTENT: Record<Lang, {
  ...
  uz: {
    ...
    sections: [
      { title: '1. Umumiy qoidalar', icon: FileText, content: "Ushbu Foydalanish shartlari TARJUMAN xizmati (bughyat alqasid Establishment, CR 7051611031, Ar-Riyod, Saudiya Arabistoni) va foydalanuvchilar o'rtasidagi munosabatlarni tartibga soladi.\n\nSaytimizdan foydalanib siz ushbu Shartlar bilan to'liq tanishganingizni tasdiqlaysiz." },
      { title: '2. Xizmatlar tavsifi', icon: FileText, content: "TARJUMAN Saudiya Arabistoni va BAA universitetlariga qabul bo'lishda talabalarni qo'llab-quvvatlash xizmatlarini ko'rsatadi:\n\n— Universitet va ta'lim dasturini tanlash bo'yicha maslahat;\n— Hujjatlarni arab tiliga tarjima qilish;\n— Ariza to'ldirish va topshirishda yordam;\n— Ariza holati monitoringi va bildirishnomalar;\n— Qabul jarayonining har bosqichida qo'llab-quvvatlash.\n\nXizmatlar hajmi tanlangan paketga (Asosiy, Standart yoki VIP) qarab belgilanadi." },
      { title: "3. Ro'yxatdan o'tish va hisob", icon: Lock, content: "3.1. Foydalanuvchi to'g'ri ma'lumotlar ko'rsatib ro'yxatdan o'tishi shart.\n\n3.2. Foydalanuvchi o'z kirish ma'lumotlari xavfsizligi uchun javobgardir.\n\n3.3. Ruxsatsiz kirish aniqlansa, darhol xabar bering: support@tarjumanedu.com" },
      { title: "4. To'lov tartibi", icon: CreditCard, content: "4.1. Xizmatlar narxi «Narxlar» sahifasida ko'rsatilgan.\n\n4.2. To'lov xizmat ko'rsatilishidan oldin amalga oshiriladi.\n\n4.3. Biz to'lov karta ma'lumotlarini saqlamaymiz.\n\n4.4. Narxlar o'zgarishi mumkin, ammo to'langan buyurtmalarga ta'sir qilmaydi." },
      { title: '5. Tomonlarning huquq va majburiyatlari', icon: Scale, content: "Foydalanuvchi majburiyatlari:\n— To'g'ri va to'liq hujjatlar taqdim etish;\n— Menejerlar so'rovlariga o'z vaqtida javob berish;\n— Xizmatdan faqat qonuniy maqsadlarda foydalanish.\n\nXizmat majburiyatlari:\n— Sifatli xizmat ko'rsatishga barcha choralarni ko'rish;\n— Biz universitetning qabul qarorini kafolatlay olmaymiz." },
      { title: '6. Taqiqlangan harakatlar', icon: ShieldOff, content: "Foydalanuvchiga quyidagilar taqiqlanadi:\n\n— Ataylab noto'g'ri yoki soxta hujjatlar taqdim etish;\n— Xizmatdan firibgarlik yoki noqonuniy maqsadlarda foydalanish;\n— Cheklovlardan qochish uchun bir nechta hisob yaratish;\n— Ruxsatsiz xizmat materiallarini nusxalash yoki qayta sotish;\n— Sayt ishlashiga zarar yetkazuvchi harakatlar;\n— Uchinchi shaxslar huquqlarini buzish.\n\nUshbu taqiqlarni buzish hisobni darhol bloklash uchun asos bo'ladi." },
      { title: "7. Mablag' qaytarish qoidalari", icon: RotateCcw, content: "7.1. To'lovdan 14 kun ichida buyurtmani bekor qilsangiz va biz hali ishni boshlamagan bo'lsak, qaytarish mumkin.\n\n7.2. Quyidagi hollarda qaytarish amalga oshirilmaydi:\n— Universitet qabul qilishdan bosh tortgan bo'lsa;\n— Foydalanuvchi to'liq bo'lmagan yoki noto'g'ri hujjatlar taqdim etgan bo'lsa;\n— Ariza bo'yicha ish allaqachon tugallangan bo'lsa;\n— 14 kundan ortiq vaqt o'tgan bo'lsa.\n\n7.3. Xizmatning bir qismi bajarilgan bo'lsa, qisman qaytarish mumkin.\n\n7.4. Tasdiqlangandan so'ng 5–10 ish kuni ichida qaytariladi.\n\n7.5. Qaytarish uchun support@tarjumanedu.com manziliga «Qaytarish — [buyurtma raqami]» mavzusi bilan yozing.\n\nTo'liq qaytarish siyosati: tarjumanedu.com/refund" },
      { title: '8. Akkauntni bloklash', icon: UserX, content: "8.1. Biz quyidagi hollarda foydalanuvchi hisobini bloklash huquqiga egamiz:\n— «Taqiqlangan harakatlar» bo'limini buzish;\n— Ataylab noto'g'ri ma'lumot berish;\n— Asossiz chargeback boshlash;\n— Firibgarlik urinishlari.\n\n8.2. Texnik imkon bo'lsa, foydalanuvchi email orqali xabardor qilinadi.\n\n8.3. Qoidabuzarlik sababli bloklashda mablag' qaytarilmaydi.\n\n8.4. Foydalanuvchi support@tarjumanedu.com manziliga yozib e'tiroz bildirishi mumkin." },
      { title: '9. Javobgarlikni cheklash', icon: Bell, content: "9.1. Biz universitetlar va viza xizmatlarining qarorlari uchun javobgar emasmiz.\n\n9.2. Biz to'liq bo'lmagan hujjatlar sababli kechikishlar uchun javobgar emasmiz.\n\n9.3. Umumiy javobgarlik to'langan paket qiymatidan oshmaydi." },
      { title: '10. Maxfiylik', icon: Lock, content: "Shaxsiy ma'lumotlarni qayta ishlash Maxfiylik siyosatiga (/privacy) muvofiq amalga oshiriladi." },
      { title: "11. Shartlarni o'zgartirish", icon: RefreshCw, content: "Biz istalgan vaqtda Shartlarni o'zgartirish huquqiga egamiz. Joriy versiya /terms sahifasida mavjud. O'zgarishlardan keyin xizmatdan foydalanishni davom ettirish yangi shartlarga rozilikni bildiradi." },
      { title: "12. Nizolar va qo'llaniladigan huquq", icon: Scale, content: "12.1. Tomonlar kelishmovchiliklarni muzokaralar orqali hal etishga intiladi.\n\n12.2. Hal etib bo'lmasa — support@tarjumanedu.com manziliga da'vo; javob muddati 10 ish kuni.\n\n12.3. Ushbu Shartlar Saudiya Arabistoni Qirolligi qonunchiligiga muvofiq tartibga solinadi." },
      { title: "13. Aloqa ma'lumotlari", icon: Phone, content: "bughyat alqasid Establishment\nCR 7051611031 · Riyadh, Kingdom of Saudi Arabia\n\nEmail: support@tarjumanedu.com\nTelegram: @tarjumanedu\nSayt: tarjumanedu.com" },
    ],
  },
  en: {
    hero: {
      ...
      <div className="pt-16 min-h-screen bg-[#F7F8FA]">
        ...
        <div className="max-w-3xl mx-auto px-4 py-12 space-y-4">
          ...
          {c.sections.map(s => {
            const Icon = s.icon
            return (
              <div key={s.title} className="bg-white rounded-2xl border border-border p-6 sm:p-8 hover:shadow-lg hover:-translate-y-0.5 transition-all duration-300">
