...
const CONTENT: Record<Lang, {
  ...
  ru: {
    ...
    note: { title: 'Ваши данные под защитой', body: 'TARJUMAN бережно относится к вашей конфиденциальности. Вопросы: support@tarjumanedu.com' },
    sections: [
      { title: '1. Кто мы', content: 'TARJUMAN — сервис сопровождения студентов при поступлении в университеты Саудовской Аравии и ОАЭ. Мы являемся оператором персональных данных, собираемых через сайт tarjumanedu.com.\n\nКонтакт: support@tarjumanedu.com' },
      ...
      { title: '3. Правовые основания обработки', content: `Мы обрабатываем ваши данные на следующих правовых основаниях:\n\n— Исполнение договора (ст. 6(1)(b) GDPR) — обработка необходима для оказания услуг, которые вы заказали;\n— Законный интерес — улучшение сервиса и предотвращение мошенничества;\n— Согласие — для маркетинговых коммуникаций (если применимо);\n— Юридическое обязательство — при требовании регуляторных органов.` },
      { title: '4. Как мы используем данные', content: '— Обработка вашей заявки и оказание услуг;\n— Коммуникация по вашему заказу;\n— Отправка уведомлений о статусе заявки;\n— Улучшение нашего сервиса;\n— Соблюдение требований законодательства.\n\nМы не используем ваши данные для рекламы и не продаём их третьим лицам.' },
  ...
  uz: {
    ...
    note: { title: "Ma'lumotlaringiz himoyalangan", body: "TARJUMAN sizning maxfiyligingizni qadrlaydi. Savollar: support@tarjumanedu.com" },
    sections: [
      { title: '1. Biz haqimizda', content: "TARJUMAN — talabalarni Saudiya Arabistoni va BAA universitetlariga qabul bo'lishda qo'llab-quvvatlash xizmati. Biz tarjumanedu.com orqali to'plangan shaxsiy ma'lumotlar operatorimiz.\n\nAloqa: support@tarjumanedu.com" },
  ...
  en: {
    ...
    note: { title: 'Your data is protected', body: 'TARJUMAN cares about your privacy. Questions: support@tarjumanedu.com' },
    sections: [
      { title: '1. Who We Are', content: `TARJUMAN is a service supporting students in applying to universities in Saudi Arabia and the UAE. We are the operator of personal data collected through tarjumanedu.com.\n\nContact: support@tarjumanedu.com` },
