...
const CONTENT: Record<Lang, {
  ...
  ru: {
    ...
    note: { title: 'Ваши данные под защитой', body: 'TARJUMAN бережно относится к вашей конфиденциальности. Вопросы: tarjuman777@gmail.com' },
    sections: [
  ...
  uz: {
    ...
    note: { title: "Ma'lumotlaringiz himoyalangan", body: "TARJUMAN sizning maxfiyligingizni qadrlaydi. Savollar: tarjuman777@gmail.com" },
    sections: [
  ...
  en: {
    ...
    note: { title: 'Your data is protected', body: 'TARJUMAN cares about your privacy. Questions: tarjuman777@gmail.com' },
    sections: [
