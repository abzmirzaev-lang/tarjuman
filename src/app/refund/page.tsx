...
const CONTENT: Record<Lang, {
  ...
  ru: {
    ...
    cta: { title: 'Нужен возврат?', sub: 'Напишите нам — разберёмся быстро и честно', email: 'tarjuman777@gmail.com', tg: 'Telegram @TARJUMAN_KSA' },
  },
  uz: {
