      ...
      <section className="section bg-[#F7F8FA]">
        <div className="container-narrow">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              {[
                { num: '43+',  label: lang === 'ru' ? 'Студентов зачислено' : lang === 'uz' ? 'Talabalar qabul qilindi' : 'Students enrolled' },
                { num: '30+',  label: lang === 'ru' ? 'Университетов-партнёров' : lang === 'uz' ? 'Hamkor universitetlar' : 'Partner universities' },
                { num: '6ч',   label: lang === 'ru' ? 'Мин. срок подачи' : lang === 'uz' ? 'Min. topshirish vaqti' : 'Min. turnaround' },
                { num: '100%', label: lang === 'ru' ? 'Возврат при отказе' : lang === 'uz' ? 'Rad etilganda qaytarish' : 'Refund on rejection' },
              ].map((s, i) => (
                <motion.div
                  key={i}
                ...
                >
                  <div className="text-3xl font-black text-brand-600 mb-1">{s.num}</div>
